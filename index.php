    ...
    <main id="home_main_content">
        <div class="row justify-content-around align-items-center mb-5">
            <div class="col-6 main-content-text p-5">
                <h1><span style="color: #fdce37;">A</span>ccess<span style="color: #fdce37;">A</span>bilty</h1>
                <p class="lead mb-4">La plateforme d'apprentissage conçue pour les personnes malvoyantes</p>
                <p>Notre outil, adaptable selon les besoins de l'utilisateur, apporte une solution numérique personnalisée en fonction des différents profils de personnes malvoyantes, leur conférant une expérience agréable et leur offrant une complète autonomie lors de leur apprentissage</p>
            </div>
